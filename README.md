...
[![CI](https://github.com/automatica-cluj/isp-2026-bookstore/actions/workflows/ci.yml/badge.svg)](https://github.com/automatica-cluj/isp-2026-bookstore/actions/workflows/ci.yml)
[![Build and Push](https://github.com/automatica-cluj/isp-2026-bookstore/actions/workflows/build-push.yml/badge.svg)](https://github.com/automatica-cluj/isp-2026-bookstore/actions/workflows/build-push.yml)
[![Release](https://img.shields.io/github/v/release/automatica-cluj/isp-2026-bookstore?include_prereleases&sort=semver)](https://github.com/automatica-cluj/isp-2026-bookstore/releases)
[![Image](https://img.shields.io/badge/ghcr.io-isp--2026--bookstore-blue?logo=docker)](https://github.com/automatica-cluj/isp-2026-bookstore/pkgs/container/isp-2026-bookstore)
...
- `ghcr.io/automatica-cluj/isp-2026-bookstore:latest` — most recent `main`
- `ghcr.io/automatica-cluj/isp-2026-bookstore:v1.2.3` — stable tag
- `ghcr.io/automatica-cluj/isp-2026-bookstore:v1.3.0-beta.1` — prerelease from `develop`
- `ghcr.io/automatica-cluj/isp-2026-bookstore:sha-abc1234` — any commit
...
```bash
APP_IMAGE=ghcr.io/automatica-cluj/isp-2026-bookstore:v1.2.3 \
  docker compose -f compose.prod.yml --env-file .env up -d
```

Browse all tags: <https://github.com/automatica-cluj/isp-2026-bookstore/pkgs/container/isp-2026-bookstore>.
